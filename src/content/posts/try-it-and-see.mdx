...
You’re trying to solve a *problem* or achieve a goal, and you think your idea will help. The question I want to answer is this:
...
> When it comes to where to each lunch, it’s safe to say that our beliefs match reality.<figcaption> &mdash; Jeremy Keith, <cite>Mental models</cite> </figcaption>
...
In these situations our <q>beliefs are likely to be misleading</q> because our brain doesn’t have a reliable model of reality.

[Click here](https://mdxjs.com)

![testing this image](../images/ipad-all-screens.png)
