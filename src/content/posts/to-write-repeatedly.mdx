...
# To write, repeatedly
Do the thing that scares you most, because it’s probably the most important thing you can do.

I’m terrified of writing, but I know I must do it. 

Every year I set a goal to write more. Yet every year, despite succeeding in other ways, I fail to write like I want to.

Last year my goal was to publish 12 blog posts. By the end of 2020, my record stood at zero published and zero attempted.
...
Why the number 12? What would 12 blog posts achieve for me? How would publishing them actually change my life for the better? 
...
I realize now what matters to me isn’t the deliverable of 12 blog posts. What I actually care about is deeper than that. It’s about my identity. 
...
### Make the goal about action
Instead of defining my goal as a deliverable, I’ve defined it as an action to take repeatedly. My revised goal is to write for 1 hour every day about something I can publish. 
...
### Put time in the calendar and show up
...
## Success is the practice, not its side effects  
