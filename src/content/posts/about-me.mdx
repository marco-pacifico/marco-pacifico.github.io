---
title: About Me (The Long Version)
date: 2021-01-28
category: Blog Post
...
I work at [Capsule](https://www.capsule.com/), where I design the workflows and tools used to run its operations. 

## You’re a designer who can…?
I make tools that help people get things done faster and easier. 

As a founding or first designer, I know how build foundational pieces like a design system, user research practice, and an iterative, evidence-based design process. I untangle and fix design debt and tech debt.
 
I’ve designed for consumers and business users; for responsive web, iOS, and products that live across multiple platforms.
...
My best decisions are made based on evidence and logic derived from first principles. I’m a fan of using frameworks to frame problems and evaluate options.

I sweat “the other 80%” of work needed to ship. That means doing QA and finessing edge cases. It also means helping my team work as a cohesive unit rather than an assembly line. I do this by showing my process and asking for feedback early to build trust, hopping on calls to clarify ambiguity, and building systems that remove friction. 
...
I’m also into photography. I used to post my photos on Instagram, but I stopped because Instagram is a hell of a drug and I had to quit.  

## Why did you make this website?
This site is a space where I can do the following:

1. Publish and practice writing.
2. Learn to code and apply those skills. 
